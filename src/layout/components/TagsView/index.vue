<template>
  <div id="tags-view-container" class="tags-view-container">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper" @scroll="handleScroll">
      ...
      >
        {{ tag.title }}
        <el-icon v-if="!isAffix(tag)" class="icon-close" @click.prevent="closeSelectedTag(tag)">
          <Close />
        </el-icon>
      </router-link>
    </scroll-pane>
...
import tagsViewStore from '@/stores/modules/tagsView'
...
export default {
  ...
  computed: {
    ...mapState(useStore, {
      ...
      theme: (store) => store.setting.theme
    })
  },
  watch: {
    $route() {
